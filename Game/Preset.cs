    ...
    internal static class Presets
    {
        public static Preset StandardSetup = new Preset()
        {
            ...
            Locations = new List<Tuple<Vector2I, PieceType>>
            {
                ...
                new Tuple<Vector2I, PieceType>(new Vector2I(6,1), PieceType.Lieutenant),
                new Tuple<Vector2I, PieceType>(new Vector2I(7,1), PieceType.Lieutenant),
                ...
                new Tuple<Vector2I, PieceType>(new Vector2I(5,2), PieceType.Lieutenant),
